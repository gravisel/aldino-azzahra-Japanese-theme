...
async function prepareRsvpData() {
    ...
    if (!name) { statusText.textContent = "Nama wajib diisi."; statusText.style.color = "red"; return; }
    if (!statusRadio) { statusText.textContent = "Pilih status."; statusText.style.color = "red"; return; }
